...
export HURD_DEBIAN_X86_64_URL=https://cdimage.debian.org/cdimage/ports/latest/hurd-amd64/debian-hurd.img.tar.gz
export HURD_DEBIAN_I686_URL=https://cdimage.debian.org/cdimage/ports/latest/hurd-i386/debian-hurd.img.tar.gz
...
# force a re-fetch.
export HURD_GENTOO_X86_64_URL=https://distfiles.gentoo.org/experimental/amd64/hurd/hurd-x86_64-preview.qcow2
export HURD_GENTOO_I686_URL=https://distfiles.gentoo.org/experimental/x86/hurd/hurd-i686-preview.qcow2
...
export HURD_GUIX_I686_URL='https://ci.guix.gnu.org/search/latest/image?query=spec:images+status:success+system:x86_64-linux+hurd-barebones.qcow2'
export HURD_GUIX_X86_64_URL='https://ci.guix.gnu.org/search/latest/image?query=spec:images+status:success+system:x86_64-linux+hurd64-barebones.qcow2'
